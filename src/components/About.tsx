...
const About: React.FC<AboutProps> = ({ onNavigate }) => {
  ...
  return (
    <section id="about" className="min-h-screen relative overflow-hidden bg-white" ref={sectionRef}>
      {/* Geometric Shapes */}
      <div className="absolute inset-0">
        <div 
          ref={shapeRef}
          className="absolute top-10 left-0 w-96 h-96 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full transform -translate-x-32 -translate-y-16 opacity-80"
        />
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tr from-blue-400 to-blue-500 transform rotate-12 translate-x-20 translate-y-20 opacity-70 rounded-3xl" />
        <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-orange-600 transform -rotate-12 opacity-20 rounded-2xl" />
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-20">
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            ...
            <div className="flex items-start space-x-8">
              ...
              <div className="flex flex-col justify-center space-y-2 pt-8">
                <div className="text-gray-400 text-sm tracking-widest">B</div>
                <div className="text-gray-400 text-sm tracking-widest">O</div>
                <div className="text-gray-400 text-sm tracking-widest">U</div>
          ...
          <div className="lg:w-1/2 lg:pl-16">
            <div className="mb-6">
              ...
              >
                Creative
                <span className="block text-orange-600">Agency</span>
              </h1>
              <p 
                ref={descriptionRef}
